...
export default class PedidoController {
  ...
  try {
    // 1. Extraímos o status, id_pedido e o ID do ADM/Checker que está logado
    const { status, id_pedido, id_adm } = req.body;
    
    // 2. Passamos o id_adm para o Service
    await PedidoController.PedidoServ.AceitacaodePedido(status, id_pedido, id_adm);
