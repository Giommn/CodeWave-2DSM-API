...
export default class PedidoService {
    ...
    // AQUI RECEBEMOS O id_adm E REPASSAMOS PARA O REPOSITORY
    public async AceitacaodePedido(status: Status, id_pedido: number, id_adm?: number) {
        return await this.PedidoRepo.descisaoPedido(status, id_pedido, id_adm);
    }
}