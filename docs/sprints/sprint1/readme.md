...
> Status do Projeto: Pronto Sprint 1! ✅
...
Estabelecer a fundação do sistema com foco no controle de acesso e na estruturação da base de dados normativa. O objetivo principal é disponibilizar um ambiente onde o Analista de Qualidade possa realizar a autenticação (login), gerenciar o acesso de novos projetistas na plataforma, e iniciar a alimentação da base de conhecimento através do cadastro e manipulação de normas técnicas aeronáuticas e seus respectivos requisitos.
...
| **Sprint 3** | Pronta ✅ |  [DOC](../sprint3/readme.md) |