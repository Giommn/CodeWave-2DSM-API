...
const Navbar: React.FC = () => {
  ...
  return (
    // Margin-top ajustada para ficar no topo da área branca
    <nav className="relative z-10 flex justify-center w-full mt-8 px-4 sm:px-6 lg:px-8 overflow-x-auto">
      <ul className="flex items-center gap-2 sm:gap-3 bg-[#70243d] rounded-full p-2 shadow-lg max-w-fit whitespace-nowrap">
        {/* Logo da Navbar (A imagem Branca) */}
        <li className="pl-4 pr-2">
          <img
            src="../../img/logo2.svg" 
            alt="Logo Akaer Navbar"
  ...
  return (
    <div className="flex flex-col rounded-xl overflow-hidden h-[280px] shadow-lg transform hover:scale-[1.02] transition-transform cursor-pointer">
      <div className="bg-[#e2e2e2] h-[160px] p-4">
        <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">{titulo}</h3>
      </div>
...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-x-hidden font-sans">
      ...
      {/* SEÇÃO SUPERIOR (Área Branca Aumentada) */}
      {/* Alterado para h-[500px] para dar mais espaço */}
      <header className="relative w-full h-[500px] flex flex-col items-center overflow-hidden bg-white">
        
        {/* Imagem de Fundo (Cores Originais e Maior) */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <img
            src="../../img/logo1.png"
            alt="Fundo Akaer"
            // Sem opacidade. Aumentado para 1200px e posicionado para cortar do jeito certo
        ...
        {/* Título Principal */}
        {/* Descido com mt-24 e fonte aumentada para bater com a imagem */}
        <div className="z-10 text-center mt-24 px-4 relative">
          <h1 className="text-4xl md:text-[52px] font-black text-[#1a1a1a] leading-tight max-w-5xl mx-auto tracking-tight">
            Bem vindo a Plataforma do Conteúdo<br />
