...
| 2 | Alta | *[História não preenchida]* | - | Sprint 1 | Fazer |
...
| 7 | Média | Como Projetista e Administrador, quero adicionar interpretação técnica a uma norma/requisito para documentar análises. | - | Sprint 2 | A fazer |
